...
<head>
    ...
    <style>
        ...
        .btn-submit { background-color: #ffc107; color: black; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer; width: 100%; font-size: 16px; font-weight: bold; }
...
<div class="form-container">
    ...
    <form action="{{ route('student.update', $student->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01" name="score" value="{{ old('score', $student->score) }}" required>
        </div>
